...
const BlockingModal = ({
  ...
  return (
    <>
      <div className="flex flex-col gap-4 px-2.5 my-5">
        <strong className="font-semibold text-2xl leading-2xl text-gray-500">
          {title}
        </strong>
        <p className="font-regular text-lg leading-lg text-gray-400">
          {description}
        </p>
      </div>
